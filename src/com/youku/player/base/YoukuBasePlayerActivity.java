...
//		}
		...
		private void showPasswordInputDialog(int title){
			LayoutInflater factory = LayoutInflater.from(YoukuPlayerApplication.context);
			final View textEntryView = factory.inflate(R.layout.yp_youku_dialog_password_interact, null);
			AlertDialog dlg = new AlertDialog.Builder(YoukuPlayerApplication.context)
			.setTitle(title)
			...
			.setPositiveButton(R.string.alert_dialog_ok,
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
							...
							YoukuBasePlayerActivity.this.doPositiveClick(password);
						}
					})
			.setNegativeButton(R.string.alert_dialog_cancel,
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
								int whichButton) {
							YoukuBasePlayerActivity.this.doNegativeClick();
						}
					}).create();
